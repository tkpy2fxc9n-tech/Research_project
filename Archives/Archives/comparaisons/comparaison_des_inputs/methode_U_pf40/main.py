# Method U_pf40: U alone as input (pipeline shared in commun.py), but with
...
# rollout (54 blocks). Does not modify methode_U/.
import sys
...
def main():
    cfg = C.Config(PF_HOPS=40)   # only change vs methode_U: everything else identical
    C.set_seeds(cfg)
