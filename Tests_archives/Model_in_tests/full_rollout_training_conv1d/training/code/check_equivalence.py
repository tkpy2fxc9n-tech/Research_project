...
# already validated in commun.py, over a few hops and a Conv1d model with
...
#
# Uses the real CONFIG_OVERRIDES from main.py (M_BACK=4) rather than
# commun.Config()'s plain defaults, so this actually exercises the
# hyperparameters training will use.
import sys
