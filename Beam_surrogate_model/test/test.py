...
#
# A boundary condition is (bc_type, waveform_family, params) -- bc_type is
# always "dirichlet" here, waveform_family one of the 5 signal families this
# project trains on: gaussian, sinusoid, step, ramp, or "rest" (quiet end) --
# see scenarios.py.
#
...
# Config/INPUT_FIELDS come from config.py (not redefined here) so the
...
RIGHT_BC = ("dirichlet", "gaussian", {"A": 0.08, "omega": 4.5})
# ============================================================


def bc_filename_tag(bc):
    bc_type, family, _ = bc
    return f"{bc_type[:1]}-{family}"  # e.g. "d-gaussian", "d-step"
