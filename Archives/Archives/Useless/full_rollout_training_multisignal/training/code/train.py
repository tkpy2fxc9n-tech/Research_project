...
# commun.sample_bc_pairs / commun.generate_dataset_general), not an
...
from Tests.full_rollout_training_multisignal.training.code._commun_path import COMMUN_DIR
from Tests.full_rollout_training_multisignal.training.code.rollout_torch import build_window_torch, reconstruct_torch_general
...
def rollout_group_tbptt(modele, group_indices, FIELDS, bc_pairs, input_fields,
...
def evaluate_val_rollout(modele, FIELDS, bc_pairs, indices_val, input_fields, norm_stats, INPUTS, OUTPUTS,
                          cfg: "C.Config") -> float:
...
def train_full_rollout(modele, FIELDS, bc_pairs, indices_train, indices_val, input_fields,
    ...
    for epoch in range(1, n_epochs + 1):
        ...
        for i, group_indices in enumerate(groups):
            ...
            avg_loss, n_updates = rollout_group_tbptt(modele, group_indices, FIELDS, bc_pairs, input_fields,
                                                        mu_in_t, sd_in_t, mu_out_t, sd_out_t, biais_repos_t,
        ...
        val_err = evaluate_val_rollout(modele, FIELDS, bc_pairs, indices_val, input_fields, norm_stats,
                                        INPUTS, OUTPUTS, cfg)
