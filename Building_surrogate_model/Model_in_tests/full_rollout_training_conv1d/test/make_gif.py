...
# make_gif.py -- only the network construction changed (ReseauConv instead
# of commun.Reseau), see training/code/model.py.
#
...
# ============================================================
A = 0.05          # amplitude of the Gaussian pulse
OMEGA = 5         # width: sigma = interp(omega, [1,10], [0.15,0.07])
