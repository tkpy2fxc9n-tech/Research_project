# Méthode U_Ut_Uxx_pf40 : U + Ut + Uxx en entrée (pipeline partagé dans commun.py), mais
...
# mieux le rollout complet (54 blocs). Ne modifie pas methode_U_Ut_Uxx/.
import sys
...
def main():
    cfg = C.Config(PF_HOPS=40)   # seul changement vs methode_U_Ut_Uxx : tout le reste identique
    C.set_seeds(cfg)
