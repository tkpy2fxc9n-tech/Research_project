# Méthode U_pf40 : U seul en entrée (pipeline partagé dans commun.py), mais
...
# mieux le rollout complet (54 blocs). Ne modifie pas methode_U/.
import sys
...
def main():
    cfg = C.Config(PF_HOPS=40)   # seul changement vs methode_U : tout le reste identique
    C.set_seeds(cfg)
