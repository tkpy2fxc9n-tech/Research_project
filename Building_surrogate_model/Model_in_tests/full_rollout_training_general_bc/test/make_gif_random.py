...
# (left, right) boundary condition pairs, using the model already trained by
# ../training/code/main.py -- showcases the network's behavior across the
# variety of BC types/waveform families it was trained on (commun.BC_WAVEFORMS:
# gaussian, sinusoid, step, ramp, random_multitone, rest), rather than a
# single hand-picked case (see make_gif.py for that).
#
# Usage:
...
# ============================================================
N_SAMPLES = 6      # number of random (left, right) boundary-condition pairs to render
