...
# normalization, for configs/runs/p8_nondim.yaml.
#
# Deliberately a standalone script, NOT a --profile option on
# dataset/make_dataset.py: that script's `cfg = Config()` line is shared by
...
# configs/runs/p8_nondim.yaml: any real gap means a dimensional
# constant leaked somewhere in the pipeline outside physics/scaling.py.
#
# Usage: python dataset/make_dataset_nondim.py
