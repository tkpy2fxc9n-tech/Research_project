...
# {"dirichlet","neumann"}, waveform_family a key in commun.BC_WAVEFORMS
# (gaussian, sinusoid, step, ramp, random_multitone, rest).
#
...
def bc_filename_tag(bc):
    bc_type, family, _ = bc
    return f"{bc_type[:1]}-{family}"  # e.g. "d-gaussian", "n-sinusoid"
