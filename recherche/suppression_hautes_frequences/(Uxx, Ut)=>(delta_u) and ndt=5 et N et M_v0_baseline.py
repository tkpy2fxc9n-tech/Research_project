# ============================================================
# VARIANTE : v0_baseline
#
# Copie de référence pour l'ablation "suppression des hautes fréquences"
# (checkerboard proche de Nyquist spatial dans le rollout autorégressif).
# AUCUNE méthode d'atténuation n'est ajoutée ou modifiée ici par rapport au
# script original : NOISE_STD=0.10, SMOOTH_ALPHA=0.20, LAMBDA_PF=1.0 restent
# aux valeurs "actuelles" du fichier source. Cette copie sert de point de
# comparaison ("baseline actuelle") pour v1..v5.
#
